        ...
        <div className="sticky top-0 h-screen flex items-center justify-center">
          <div className="relative w-full">
            ...
            <div className="relative z-10 grid grid-cols-1 gap-4 px-6 md:grid-cols-2 md:px-12 lg:px-20">
              {/* Trust & Authenticity - comes from left */}
              <div 
              ...
              >
                <Image
                  src="/images/pain-points-fraud.png"
                  alt="Trust and authenticity in exports"
                  fill
              ...
              {/* Quality Assurance - comes from right */}
              <div 
                className="relative aspect-[4/3] overflow-hidden rounded-2xl"
                style={{
              ...
              >
                <Image
                  src="/images/pain-points-quality.png"
      ...
      <div className="px-6 py-20 md:px-12 md:py-28 lg:px-20 lg:py-36 lg:pb-14">
        <div className="text-center">
          ...
          <p className="mt-8 leading-relaxed text-muted-foreground text-3xl text-center">
            The global export market faces critical challenges: counterfeit products eroding trust, inconsistent quality standards, communication breakdowns, and lack of transparency. AMEY EXIM was founded to solve these problems with integrity and excellence.
          </p>
        </div>
      </div>
    </section>
