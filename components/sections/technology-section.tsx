...
export function TechnologySection() {
  ...
  const descriptionText = "AMEY EXIM operates three specialized divisions: Pharmaceutical excellence with rigorous compliance and quality standards, Agricultural products sourced from premium farms worldwide, and Cosmetic manufacturing with cutting-edge beauty innovations. Each division maintains the highest international standards and comprehensive traceability.";
            ...
            >
              ...
              >
                <h2 className="max-w-3xl font-medium leading-tight tracking-tight text-white md:text-5xl lg:text-7xl text-5xl">
                  {["Our Three", "Expert", "Divisions."].map((word, index) => {
                    // Each word fades out sequentially based on scrollProgress
                    const wordFadeStart = index * 0.07; // Our: 0, Three: 0.07, Expert: 0.14
